...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 md:py-36 px-6 section-glow">
      <div ref={ref} className={`max-w-4xl mx-auto reveal ${visible ? 'visible' : ''}`} style={{ position: 'relative', zIndex: 1 }}>
